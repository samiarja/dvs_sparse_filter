...
#include <stdexcept>
#include <vector>
#include </home/samiarja/Desktop/PhD/Code/dvs_sparse_filter/eigen-3.4.0/Eigen/Dense>
#include </home/samiarja/Desktop/PhD/Code/dvs_sparse_filter/eigen-3.4.0/unsupported/Eigen/MatrixFunctions>
...
static PyMethodDef dvs_sparse_filter_extension_methods[] = {
...
static struct PyModuleDef dvs_sparse_filter_extension_definition = {
    PyModuleDef_HEAD_INIT,
    "dvs_sparse_filter_extension",
    "dvs_sparse_filter_extension speeds up some sessiontools operations",
    -1,
    dvs_sparse_filter_extension_methods};
PyMODINIT_FUNC PyInit_dvs_sparse_filter_extension() {
    auto module = PyModule_Create(&dvs_sparse_filter_extension_definition);
    import_array();
    return module;
}
